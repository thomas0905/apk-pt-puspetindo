                    ...
                    <div className="flex-1 mt-20">
                        <nav className="grid items-start fixed px-2 text-sm font-medium lg:px-4">
                            ...
                            <span className="flex text-xm flex-col items-start gap-1 mt-3 rounded-lg px-2 text-muted-foreground transition-all">
                                ...
                                <Link href='/pengguna' className={`flex pl-2 text-black rounded-sm p-1 gap-2 text-md transition-all duration-200 ${isActive('/pengguna') ? 'bg-blue-600 text-white w-[190px]' : 'hover:text-white hover:w-[190px] hover:bg-blue-600 w-full'
                                    }`}>
